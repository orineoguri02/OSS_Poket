...
export default function Home() {
  ...
  return (
    ...
    >
      <h1 style={{ textAlign: 'center', color: '#333' }}>포켓몬 도감 (2D Home)</h1>
      ...
      <div style={{
        ...
        {pokemonIds.map((id) => (
          ...
          <Link to={`/pokemon/${id}`} key={id} style={{ textDecoration: 'none' }}>
            <div style={{
            ...
            >
              ...
              <img
                ...
                loading="lazy"
              />
              <p style={{ margin: '10px 0 0', color: '#555', fontWeight: 'bold' }}>No. {id}</p>
            </div>
          </Link>
        ))}
      </div>
